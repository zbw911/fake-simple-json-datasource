...
app.all('/a', function (req, res) {
    ...
    setCORSHeaders(res);
    console.log(req.url, req.params, req.query, req.query['cmd'], req.body)
...
//     setCORSHeaders(res);
//     res.send('I have a quest for you!');
//     console.log('I have a quest for you!')
//     res.end();
// });

// app.all('/a/search', function (req, res) {
//     setCORSHeaders(res);
//     var result = [];
//     _.each(timeserie, function (ts) {
//         result.push(ts.target);
...
// app.all('/a/annotations', function (req, res) {
//     setCORSHeaders(res);
//     console.log(req.url);
...
// app.all('/a/query', function (req, res) {
//     setCORSHeaders(res);
//     console.log(req.url);
//     console.log(req.body);
//
...
// app.all('/a/tag[\-]keys', function (req, res) {
//     setCORSHeaders(res);
//     console.log(req.url);
//     console.log(req.body);
//
